 ...
 */
	...
	if ($ledger_id != 0)
	{
		...
		echo "<td align=\"right\">" . convert_opening($opbalance, $optype) . "</td>";
		echo "</tr>";
		echo "<tr>";
		echo "<td><b>Closing Balance</b></td>";
		echo "<td align=\"right\">" . convert_amount_dc($clbalance) . "</td>";
		echo "</tr>";
		echo "</table>";
		echo "<br />";
		if ( ! $print_preview) {
		...
		echo "<thead><tr><th>Date</th><th>No.</th><th>Ledger Name</th><th>Type</th><th align=\"right\">Dr Amount</th><th align=\"right\">Cr Amount</th><th align=\"right\">Balance</th></tr></thead>";
		$odd_even = "odd";
		...
		if ($page_count <= 0)
		{
			...
			echo "<tr class=\"tr-balance\"><td colspan=6>Opening</td><td align=\"right\">" . convert_amount_dc($cur_balance) . "</td></tr>";
		}
