        ...
        <div id="main">
            <?php if (isset($nav_links)) {
                ...
                foreach ($nav_links as $link => $title) {
                    ...
                    elseif ($title == 'Download CSV') {
                        echo "<li>" . anchor_download($link, $title, array('title' => $title, 'class' => 'nav-links-item', 'style' => 'background-image:url(\'' . asset_url() . 'images/buttons/navlink.png\');')) . "</li>";
...
<div id="footer">
    ...
    <!--<a href="http://madrona.phpfogapp.com" target="_blank">CiviLedger<a/> is licensed under <a href="http://www.gnu.org/licenses/agpl-3.0.txt" target="_blank">GNU Affero General Public License, version 3</a> as published by the Free Software Foundation.-->
</div>
