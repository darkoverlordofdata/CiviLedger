...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
Posting Period : <span class="bold"><?php echo $cur_entry->fiscal_period." / ".$cur_entry->fiscal_year; ?></span>
</p>
...
<?php 
	...
	echo " | ";
	echo anchor_popup('entry/printpreview/' .  $current_entry_type['label'] . "/" . $cur_entry->id , 'Print', array('title' => 'Print this ' . $current_entry_type['name'] . ' Entry', 'width' => '800', 'height' => '600'));
	echo " | ";
	echo anchor_popup('entry/email/' .  $current_entry_type['label'] . "/" . $cur_entry->id , 'Email', array('title' => 'Email this ' . $current_entry_type['name'] . ' Entry', 'width' => '500', 'height' => '300'));
	echo " | ";
