...
echo "<thead><tr><th>Account</th><th>Prefix</th><th>Use CMS</th><th>Hostname</th><th>Port</th><th>Database</th><th>Username</th><th></th><th></th></tr></thead>";
echo "<tbody>";
$odd_even = "odd";
foreach ($accounts as $label)
{
	...
	if (get_file_info($ini_file))
	{
		...
		if ($active_accounts)
		{
            $db_prefix = isset($active_accounts['db_prefix']) ? $active_accounts['db_prefix'] : "-";
            $use_cms = isset($active_accounts['use_cms']) ? $active_accounts['use_cms'] : "-";
