...
|
*/
$config['encryption_key'] = ';$UKd\'D(AEHZlP:luaSG]1Jc<>Ul_+:H';
...
$config['asset_path'] = FCURL.'application/assets/';
...
$config['config_path'] = FCURL.'config/';
...
$config['backup_path'] = FCURL.'backups/';
