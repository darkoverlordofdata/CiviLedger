...
class Entry extends CI_Controller {
	...
	function add($entry_type)
	{
        ...
        $data['fiscal_year'] = $this->config->item('fiscal_year');
        $data['fiscal_period'] = $this->config->item('fiscal_period');
		...
		else
		{
			...
			$insert_data = array(
				...
				'tag_id' => $data_tag,
				'fiscal_year' => $this->config->item('fiscal_year'),
                'fiscal_period' => $this->config->item('fiscal_period'),
			);
	...
	function edit($entry_type, $entry_id = 0)
	{
        ...
        $data['fiscal_year'] = $cur_entry->fiscal_year;
        $data['fiscal_period'] = $cur_entry->fiscal_period;
