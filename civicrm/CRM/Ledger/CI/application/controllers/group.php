...
class Group extends CI_Controller {
    ...
    function add()
    {
        ...
        /* Form validations */
        $this->form_validation->set_rules('group_id', 'Group id', 'trim|required|min_length[3]|max_length[10]|');
        ...
        if ($_POST)
        {
            $data['group_id']['value'] = $this->input->post('group_id', TRUE);
        ...
        {
            $data_id = $this->input->post('group_id', TRUE);
