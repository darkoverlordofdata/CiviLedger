...
if ( ! function_exists('date_php_to_mysql'))
{
	function date_php_to_mysql($dt)
	{
		...
		case 'yyyy/mm/dd':
			...
			break;
		default:
            $CI->messages->add('date_php_to_mysql: Invalid date format "'.$current_date_format.'". Check your account settings.', 'error');
			return "";
		}
...
if ( ! function_exists('date_php_to_mysql_end_time'))
{
	function date_php_to_mysql_end_time($dt)
	{
		...
		case 'yyyy/mm/dd':
			...
			break;
		default:
            $CI->messages->add('date_php_to_mysql_end_time: Invalid date format "'.$current_date_format.'". Check your account settings.', 'error');
			return "";
		}
...
if ( ! function_exists('date_mysql_to_php'))
{
	function date_mysql_to_php($dt)
	{
		...
		case 'yyyy/mm/dd':
			...
			break;
		default:
			$CI->messages->add('date_mysql_to_php: Invalid date format "'.$current_date_format.'". Check your account settings.', 'error');
			return "";
		}
		return;
	}
...
if ( ! function_exists('date_mysql_to_php_display'))
{
	function date_mysql_to_php_display($dt)
	{
		...
		case 'yyyy/mm/dd':
			...
			break;
		default:
            $CI->messages->add('date_mysql_to_php_display: Invalid date format "'.$current_date_format.'". Check your account settings.', 'error');
			return "";
		}
		return;
	}
...
if ( ! function_exists('date_today_php'))
{
	function date_today_php()
	{
		...
		case 'yyyy/mm/dd':
			...
			break;
		default:
            $CI->messages->add('date_today_php: Invalid date format "'.$current_date_format.'". Check your account settings.', 'error');
			return "";
		}
		return;
	}
